                            ...
                            <tr>
                                <th onClick={() => sortData('nickname')}>
                                    ...
                                    <button className="sort-button">
                                        {sortConfig.key === 'nickname' ? (sortConfig.direction === 'ascending' ? '▲' : '▼') : '↕'}
                                    </button>
                                </th>
                                ...
                                <th onClick={() => sortData('totalTime')}>
                                    업무 총시간
                                    <button className="sort-button">
                                        {sortConfig.key === 'totalTime' ? (sortConfig.direction === 'ascending' ? '▲' : '▼') : '↕'}
                                    </button>
                                </th>
                                <th onClick={() => sortData('reportStatus')}>
                                    업무 보고서
                                    <button className="sort-button">
                                        {sortConfig.key === 'reportStatus' ? (sortConfig.direction === 'ascending' ? '▲' : '▼') : '↕'}
                                    </button>
                                </th>
                            </tr>
                        </thead>
                            ...
                            {currentData.length > 0 ? (
                                currentData.map((employee, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button
                                                className={`status-button ${employee.reportStatus === '수집 중' ? 'collecting' : 'completed'}`}
                                                onClick={() => handleReportClick(employee)}
                                                style={employee.reportStatus === '수집 중' ? { cursor: 'default', pointerEvents: 'none' } : {}}
                                            >
                    ...
                    <div className="dailywork-modal">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="4" className="section-header">담당 업무</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colSpan="4" className="section-header">키워드 분석</td>
                                </tr>
                                <tr>
                                    <td colSpan="4">{reportData.keywords}</td>
                                </tr>
                            </tbody>
                        </table>
